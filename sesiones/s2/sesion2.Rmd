...
- De la tabla podemos concluir que $P(y{1i}=1)=10/200=0.5$, es decir, la mitad de quienes reciben el trasplante morirían después de cinco días
...
$$
\begin{aligned}
E(y_i|D_i=1)-E(y_i|D_i=0)=&\overbrace{ E(y_{1i}|D_i=1)-E(y_{0i}|D_i=1)}^{\text{Efecto promedio en los tratados}}+\\& \underbrace{E(y_{0i}|D_i=1)-E(y_{oi}|D_i=0)}_{Sesgo de selección}
\end{aligned}
$$
...
& =E(y_{1i}-y_{0i}|D_i=1) \\
& =\underbrace{E(y_{1i}-y_{0i})}_{Efecto causal}
\end{aligned}
$$
