...
- Anagol, S., y Fujiwara, T. (2016). [The runner-up effect](Anagol, S., & Fujiwara, T. (2016). The runner-up effect. Journal of Political Economy, 124(4), 927-991).
...
- [Calonic, Cattaneo & Titiunik, (2015)](https://rdpackages.github.io/references/Calonico-Cattaneo-Titiunik_2015_R.pdf) proponen distintas formas de implementar algoritmos para seleccionar el ancho de ventana óptimo, operacionalziado en la libraría *rdrobust*
...
.pull-left[
- Usando *rdbwselect* se pueden calcular distintos anchos de ventana, dependiendo del peso que se le de a cada observación
