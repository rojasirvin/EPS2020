...
date: "Fecha de entrega: XX de septiembre a las 11:00."
output:
  html_document:
  toc: true
---
...
Suponga que desea evaluar el impacto de las medidas de sana distancia realizadas por el gobierno de un país para reducir la mortalidad causada por el covid-19. Suponga que hubiera tenido la oportunidad implementar un experimento **antes** de que la epidemia se realizará.
