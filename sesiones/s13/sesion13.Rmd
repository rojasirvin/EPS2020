...
- $T_s$ es una dummy igual a 1 para Alabama en todos los periodos e igual a 0 para Arkansas en todos los periodos

- $POST=\begin{cases} 0 \quad\text{1970-1975} \\ 1 \quad\text{1976-1983} \\ \end{cases}$
