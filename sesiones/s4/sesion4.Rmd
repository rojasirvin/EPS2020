...
.pull-right[
```{r, out.width="100%",fig.cap='Fuente: Banerjee et al. (2015)',fig.align='center'}
knitr::include_graphics("figures/sixcountries_balance.png")
```
]
...
.pull-right[
```{r, out.width="88%",fig.cap='Fuente: Banerjee et al. (2015)',fig.align='center'}
knitr::include_graphics("figures/sixcountries_attrition.png")
```
]
